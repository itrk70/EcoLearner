...
CREATE TABLE Users (
    ...
    -- Forgot Password OTP storage. Both NULL most of the time - only
    -- filled in temporarily between "user requested a reset code" and
    -- "code was verified or expired." otp_created_at lets the backend
    -- reject codes older than a few minutes.
    otp_code        TEXT,
    otp_created_at  TEXT,
